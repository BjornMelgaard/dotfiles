# TO INSTALL
# nix-build -E 'with import <nixpkgs> { config = { allowUnfree = true; }; }; callPackage ./scripts/vscode-live.nix {}' --no-out-link
# rm -dfr $HOME/.vscode/extensions/ms-vsliveshare.vsliveshare*
# ln -s -T /nix/store/jp4z8m7ih6vrb63ri2qnnkr066v06sbx-vscode-extension-ms-vsliveshare-vsliveshare-0.3.504/share/vscode/extensions/ms-vsliveshare.vsliveshare $HOME/.vscode/extensions/ms-vsliveshare.vsliveshare
